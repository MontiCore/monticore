...
modeling language (cf. [Chapter 4 of the MontiCore handbook](www.monticore.de/handbook.pdf)), 
...
[Chapter 4 of the MontiCore handbook](www.monticore.de/handbook.pdf).
...
<img src="https://github.com/MontiCore/monticore/blob/dev/docs/docs/small_bulb.png" width="25">
...
[Chapter 4 and Chapter 9 of the MontiCore handbook](www.monticore.de/handbook.pdf). 
For example, the
...
described in [Chapter 4 of the MontiCore handbook](www.monticore.de/handbook.pdf). 
...
(cf. [Section 5.10 of the MontiCore handbook](www.monticore.de/handbook.pdf)).
...
2.  Java source files for the corresponding DSL infrastructure are
    ...
    -   `out/automata/_ast` containing the abstract syntax tree data
        structure (cf. [Chapter 5 of the MontiCore handbook](www.monticore.de/handbook.pdf)).
    -   `out/automata/_auxiliary` containing adapted mills of sublanguages,
        ...
        (cf. [Chapter 11 of the MontiCore handbook](www.monticore.de/handbook.pdf)).
    -   `out/automata/_cocos` containing the infrastructure for context
        conditions (cf. [Chapter 10 of the MontiCore handbook](www.monticore.de/handbook.pdf)).
    ...
    -   `out/automata/_parser` containing the generated parsers, which are
        based on ANTLR (cf. [Chapter 6 of the MontiCore handbook](www.monticore.de/handbook.pdf)).
    -   `out/automata/_symboltable` containing the infrastructure for the symbol
        table (cf. [Chapter 6 of the MontiCore handbook](www.monticore.de/handbook.pdf)).
    -   `out/automata/_visitor` containing the infrastructure for visitors
        (cf. [Chapter 9 of the MontiCore handbook](www.monticore.de/handbook.pdf)).
...
(cf. [Chapter 5 of the MontiCore handbook](www.monticore.de/handbook.pdf)). For
...
![](https://github.com/MontiCore/monticore/blob/dev/docs/docs/GenAutomataAST.png)
...
found in [Chapter 9 of the MontiCore handbook](www.monticore.de/handbook.pdf).
...
[Chapter 6 of the MontiCore handbook](www.monticore.de/handbook.pdf).

Parts of the class `AutomataParser` generated from the `Automata`
grammar.

![](https://github.com/MontiCore/monticore/blob/dev/docs/docs/GenAutomataParser.png)
...
described in [Chapter 9 of the MontiCore handbook](www.monticore.de/handbook.pdf). 
...
![](https://github.com/MontiCore/monticore/blob/dev/docs/docs/GenAutomataScopes.png)
...
![](https://github.com/MontiCore/monticore/blob/dev/docs/docs/GenAutomataSymbols.png)
...
explained in [Chapter 7 and Chapter 9 of the MontiCore handbook](www.monticore.de/handbook.pdf).
...
![](https://github.com/MontiCore/monticore/blob/dev/docs/docs/GenAutomataVisitors.png)
...
[Chapter 8 of the MontiCore handbook](www.monticore.de/handbook.pdf).
...
described in [Chapter 10 of the MontiCore handbook](www.monticore.de/handbook.pdf).
...
-   `hwc/automata/_symboltable` contains handwritten extensions of the
    ...
    [Chapter 9 of the MontiCore handbook](www.monticore.de/handbook.pdf).
...
[Chapter 16 of the MontiCore handbook](www.monticore.de/handbook.pdf). This
...
![](https://github.com/MontiCore/monticore/blob/dev/docs/docs/Eclipse.png)
...
![](https://github.com/MontiCore/monticore/blob/dev/docs/docs/IntelliJ-IDEA.png)
