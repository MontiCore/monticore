...
| MontiFun Tool                       | Parser, well-formedness checker, pretty printer, Java generator, and REPL for the [MontiFun Language](https://github.com/MontiCore/montifun/blob/dev/README.md).                                                                                                                  | [Download JAR](https://www.monticore.de/download/MCMontiFun.jar)                         |
