...
public class TemplateAliasingTest {
  ...
  public void testRequiredGlobalVarValid() {
    ...
    assertTrue(LogStub.getPrints().isEmpty(), "Log not empty!\n" + LogStub.getPrints());
    assertTrue(Log.getFindings().isEmpty());
  }
  ...
  public void testRequiredGlobalVarInvalid() {
    tc.include(ALIASES_PACKAGE + "RequiredGlobalVarAlias");
    assertFalse(LogStub.getPrints().isEmpty(), "Log is empty but error was expected!");
  }
  ...
  public void testRequiredGlobalVarsInvalid() {
    ...
    assertFalse(LogStub.getPrints().isEmpty(), "Log empty, expected error");
  }
  ...
  public void testDefineGlobalVarAliasValid(){
    ...
    assertTrue(LogStub.getPrints().isEmpty(), "Log is not empty, messages: "  + LogStub.getPrints());
    assertTrue(Log.getFindings().isEmpty());
  }
  ...
  private static void assertErrors(Collection<String> expectedErrors,
    ...
    for (String expectedError : expectedErrors) {
      ...
      assertTrue(found, "The following expected error was not found: " + expectedError
          + actualErrorsJoined);
    }
  }
