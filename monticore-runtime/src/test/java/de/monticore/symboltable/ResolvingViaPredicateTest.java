...
public class ResolvingViaPredicateTest {
  ...
  public void testResolveOnlyActionWithMatchingParameters() {
    final EntitySymbol entitySymbol = new EntitySymbol("E");
    entitySymbol.getSpannedScope().addResolver(CommonResolvingFilter.create(ActionSymbol.KIND));
    entitySymbol.getSpannedScope().addResolver(CommonResolvingFilter.create(PropertySymbol.KIND));
    ...
    a1.getSpannedScope().addResolver(CommonResolvingFilter.create(PropertySymbol.KIND));
    ...
    a2.getSpannedScope().addResolver(CommonResolvingFilter.create(PropertySymbol.KIND));
