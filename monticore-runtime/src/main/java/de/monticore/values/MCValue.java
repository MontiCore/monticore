...
public interface MCValue {
   ...
   *
   * @return The value as an {@link MCValueObject}, iff it is one.
   */
  default MCValueObject asObject() {
    throw new IllegalStateException();
  }
   ...
   */
  boolean checkEqualityOperator(MCValue other);
