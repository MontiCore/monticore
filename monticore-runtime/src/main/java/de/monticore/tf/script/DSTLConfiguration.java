 ...
 *
 */
public class DSTLConfiguration implements Configuration {
  ...
  public static final String DEFAULT_REPORT_DIRECTORY = "target/generated-sources/reports";
  ...
  public enum Options {
    ...
    OUT("out"), OUT_SHORT("o"), TARGETPATH("targetPath"), TARGETPATH_SHORT("tp"), NODEFACTORY("nodeFactory"), FORCE("force"), FORCE_SHORT("f"),
    TEMPLATEPATH("templatePath"), TEMPLATEPATH_SHORT("fp"), REPORT("report"), REPORT_SHORT("r");;
  ...
  /**
   * Factory method for {@link DSTLConfiguration}.
   */
  public static DSTLConfiguration withConfiguration(Configuration configuration) {
    return new DSTLConfiguration(configuration);
  }

  private final Configuration configuration;

  /**
   * Constructor for {@link DSTLConfiguration}
   */
  private DSTLConfiguration(Configuration internal) {
  ...
  public MCPath getModels(String extension) {
   ...
   * default is "target/generated-sources/reports".
   *
   * @return output directory file
   */
  public File getReport() {
    ...
    // fallback default is "target/reports"
