...
public interface ModelNameCalculator {
   ...
   * of a class diagram. To resolve a type <code>T</code> defined in a class diagram a.b.CD, first <code>a
   * .b.CD.MyClass</code> in the path <code>a/b/CD/MyClass.cd</code> would fail, since
   * <code>MyClass</code> is not a top level element and consequently no file <code>MyClass
