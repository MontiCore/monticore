...
public interface MCGrammarsSourceDirectorySet extends SourceDirectorySet {
  ...
  abstract class DefaultMCGrammarsSourceDirectorySet extends DefaultSourceDirectorySet implements MCGrammarsSourceDirectorySet {
    @Inject
    public DefaultMCGrammarsSourceDirectorySet(SourceDirectorySet sourceSet, TaskDependencyFactory taskDependencyFactory) {
