...
public class InterfaceNTOnlyExtendInterfaceNTsTest extends CocoTest {
  ...
  private final String CODE = "0xA2116";
  ...
  public void testExtendAbstractNT(){
    testInvalidGrammar(grammar+"a", CODE, String.format(MESSAGE," abstract"), checker);
  }
  ...
  public void testExtendNormalNT(){
    testInvalidGrammar(grammar+"c", CODE, String.format(MESSAGE,""), checker);
  }
