...
public class SymbolAndScopeTranslationTest extends TranslationTestCase {
  ...
  public void testSymbolClassOverwritten() {
    ...
    assertEquals("inheritedSymbol", astType.getModifier().getStereotype().getValues(0).getName());
    assertFalse(astType.getModifier().getStereotype().getValues(0).getValue().isEmpty());
    assertEquals("mc2cdtransformation.symboltransl.symbolrule._symboltable.SymbolClassSymbol", astType.getModifier().getStereotype().getValues(0).getValue());
  ...
  public void testSymbolClassExtents() {
    ...
    assertEquals("inheritedSymbol", astType.getModifier().getStereotype().getValues(0).getName());
    assertFalse(astType.getModifier().getStereotype().getValues(0).getValue().isEmpty());
    assertEquals("mc2cdtransformation.symbolandscopetranslation._symboltable.FooSymbol", astType.getModifier().getStereotype().getValues(0).getValue());
  ...
  public void testSymbolInterfaceOverwritten() {
    ...
    assertEquals("inheritedSymbol", astType.getModifier().getStereotype().getValues(0).getName());
    assertFalse(astType.getModifier().getStereotype().getValues(0).getValue().isEmpty());
    assertEquals("mc2cdtransformation.symboltransl.symbolrule._symboltable.SymbolInterfaceSymbol", astType.getModifier().getStereotype().getValues(0).getValue());
  ...
  public void testSymbolInterfaceImplements() {
    ...
    assertEquals("inheritedSymbol", astType.getModifier().getStereotype().getValues(0).getName());
    assertFalse(astType.getModifier().getStereotype().getValues(0).getValue().isEmpty());
    assertEquals("mc2cdtransformation.symbolandscopetranslation._symboltable.InterfaceFooSymbol", astType.getModifier().getStereotype().getValues(0).getValue());
  ...
  public void testSymbolAbstractClassOverwritten() {
    ...
    assertEquals("inheritedSymbol", astType.getModifier().getStereotype().getValues(0).getName());
    assertFalse(astType.getModifier().getStereotype().getValues(0).getValue().isEmpty());
    assertEquals("mc2cdtransformation.symboltransl.symbolrule._symboltable.SymbolAbstractClassSymbol", astType.getModifier().getStereotype().getValues(0).getValue());
  ...
  public void testSymbolAbstractClassExtents() {
    ...
    assertEquals("inheritedSymbol", astType.getModifier().getStereotype().getValues(0).getName());
    assertFalse(astType.getModifier().getStereotype().getValues(0).getValue().isEmpty());
    assertEquals("mc2cdtransformation.symbolandscopetranslation._symboltable.AbstractFooSymbol", astType.getModifier().getStereotype().getValues(0).getValue());
