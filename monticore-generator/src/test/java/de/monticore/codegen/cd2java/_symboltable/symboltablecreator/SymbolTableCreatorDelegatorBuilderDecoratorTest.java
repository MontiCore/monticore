...
public class SymbolTableCreatorDelegatorBuilderDecoratorTest extends DecoratorTestCase {
  ...
  public void testSetGlobalScopeMethod() {
    ...
    ASTMCType astType = this.MCTypeFacade.createTypeByDefinition(I_A_GLOBAL_SCOPE);
    assertEquals(1, method.sizeCDParameters());
    assertDeepEquals(astType, method.getCDParameter(0).getMCType());
  ...
  public void testBuildMethod() {
    ...
    assertDeepEquals(PUBLIC, method.getModifier());
    assertDeepEquals(MCTypeFacade.createQualifiedType("ASymbolTableCreatorDelegator"), method.getMCReturnType().getMCType());
