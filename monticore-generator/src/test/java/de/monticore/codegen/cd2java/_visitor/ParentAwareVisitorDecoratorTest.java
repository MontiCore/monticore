...
import static de.monticore.cd.facade.CDModifier.PACKAGE_PRIVATE_FINAL;
...
public class ParentAwareVisitorDecoratorTest extends DecoratorTestCase {
  ...
  public void testTraverseASTAbstractClass() {
    ...
    assertTrue(methodList.stream().noneMatch(m -> astType.deepEquals(m.getCDParameters(0).getMCType())));
  }
