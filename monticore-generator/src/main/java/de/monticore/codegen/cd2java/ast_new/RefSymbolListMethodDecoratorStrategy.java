...
public class RefSymbolListMethodDecoratorStrategy extends ListMethodDecoratorStrategy {
  ...
  protected RefSymbolListMethodDecoratorStrategy(GlobalExtensionManagement glex, MandatoryMethodDecoratorStrategy mandatoryMethodDecoratorStrategy, ASTType refSymbolType, String refSymbolSimpleName) {
