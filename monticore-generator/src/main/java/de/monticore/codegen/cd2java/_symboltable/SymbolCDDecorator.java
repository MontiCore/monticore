...
public class SymbolCDDecorator extends AbstractCreator<ASTCDCompilationUnit, ASTCDCompilationUnit> {
...
//  protected final SymbolTableCreatorBuilderDecorator symbolTableCreatorBuilderDecorator;
  ...
  public SymbolCDDecorator(final GlobalExtensionManagement glex,
...
//    this.symbolTableCreatorBuilderDecorator = symbolTableCreatorBuilderDecorator;
  ...
  @Override
  public ASTCDCompilationUnit decorate(ASTCDCompilationUnit symbolCD) {
    List<String> symbolTablePackage = new ArrayList<>(symbolCD.getPackageList());
    symbolTablePackage.addAll(Arrays.asList(symbolCD.getCDDefinition().getName().toLowerCase(), SYMBOL_TABLE_PACKAGE));

    List<ASTCDType> symbolProds = symbolTableService.getSymbolDefiningProds(symbolCD.getCDDefinition());
...
//    ASTCDClass scopeClass = createScopeClass(ast);
    ...
    ASTCDDefinition astCD = CD4AnalysisMill.cDDefinitionBuilder()
        .setName(symbolCD.getCDDefinition().getName())
