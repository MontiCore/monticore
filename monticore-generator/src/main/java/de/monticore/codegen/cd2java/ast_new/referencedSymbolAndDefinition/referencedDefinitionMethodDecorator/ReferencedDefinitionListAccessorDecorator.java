...
public class ReferencedDefinitionListAccessorDecorator extends ListAccessorDecorator {
  ...
  protected ASTCDMethod createGetListMethod(ASTCDAttribute ast) {
    ...
    this.replaceTemplate(EMPTY_BODY, getList, new TemplateHookPoint("ast_new.refSymbolMethods.GetDefinitionList", ast.getName(), referencedSymbolType, simpleSymbolName));
    return getList;
  }
}
