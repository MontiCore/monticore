...
import de.monticore.generating.templateengine.reporting.commons.ReportLogHookFix;
 ...
 * Future-porting the reporting-logger-changes, copy of Reporting.java
 * ---
...
public class ReportingFix extends Log {
  ...
  public static boolean isInitialized() {
    // We probably should check if a ReportLogHookFix is present in the Log
  ...
  static List<ReportLogHookFix> reportHooks = new ArrayList<>();

  protected static List<ReportLogHookFix> getReportHooks() {
    return reportHooks;
  }

  public static void addReportHook(ReportLogHookFix reportHook) {
   ...
   * {@link TemplateController#writeArgs(String, String, String, ASTNode, List)
   ...
   * {@link TemplateController#include(List, List)
   * include} or
   * {@link TemplateController#includeArgs(String, List)
