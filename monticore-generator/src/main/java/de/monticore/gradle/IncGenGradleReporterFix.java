...
public class IncGenGradleReporterFix extends IncGenReporterFix {
  ...
  public IncGenGradleReporterFix(String outputDir, Function<Path, Path> reportPathOutput, String modelName) {
    this(outputDir, reportPathOutput, modelName, "mc4");
  }

  public IncGenGradleReporterFix(String outputDir, Function<Path, Path> reportPathOutput, String modelName, String fileExtension) {
