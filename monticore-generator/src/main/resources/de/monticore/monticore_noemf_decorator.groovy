...
for (astGrammar in getParsedGrammars()) {
    ...
    decoratedCD = decorateCd(glex, astClassDiagram.deepClone(), handcodedPath)
    ...
    generateAST(glex, globalScope, decoratedCD, out)
    generate(glex, globalScope, astClassDiagram, out)
