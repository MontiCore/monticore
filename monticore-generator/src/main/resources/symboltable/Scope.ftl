...
<#list symbolNames?keys as symbol>
  ...
  protected Optional<ICommon${languageName}Symbol<?>> spanningSymbol = Optional.empty();
  ...
  @Override 
  public void setSpanningSymbol(ICommon${languageName}Symbol<?> symbol) {
  ...
  public void setExportsSymbols(boolean b) {
   ...
   public Optional<ICommon${languageName}Symbol<?>> getSpanningSymbol() {
