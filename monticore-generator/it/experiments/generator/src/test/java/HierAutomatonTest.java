 ...
 */
public class HierAutomatonTest {
  ...
  public void toolTest() {
    ...
    Log.info("src/test/resources/example/HierarchyPingPong.aut" + " parsed successfully!", HierAutomatonTest.class.getName());
    
    // --------------------------------------------------------
    // execute a generation process
    Log.info("Writing the parsed automaton into File:", HierAutomatonTest.class.getName());
