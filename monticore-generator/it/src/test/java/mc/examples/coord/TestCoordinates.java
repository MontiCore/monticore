...
public class TestCoordinates extends GeneratorIntegrationsTest {
  ...
  public void testCoordcartesianParser() throws IOException {
    ...
    assertEquals(astCartesian.get().getCoordinatesList().size(), 3);
    
    assertEquals(astCartesian.get().getCoordinatesList().get(0).getX(), 2);
    assertEquals(astCartesian.get().getCoordinatesList().get(0).getY(), 4);
    
    assertEquals(astCartesian.get().getCoordinatesList().get(1).getX(), 5);
    assertEquals(astCartesian.get().getCoordinatesList().get(1).getY(), 2);
    
    assertEquals(astCartesian.get().getCoordinatesList().get(2).getX(), 1);
    assertEquals(astCartesian.get().getCoordinatesList().get(2).getY(), 7);
  }
  ...
  public void testCoordpolarParser() throws IOException {
    ...
    assertEquals(astPolar.get().getCoordinatesList().size(), 3);
    

    
    assertEquals(astPolar.get().getCoordinatesList().get(0).getD(), 1.0, DELTA);
    assertEquals(astPolar.get().getCoordinatesList().get(0).getPhi(), 0.5, DELTA);
    
    assertEquals(astPolar.get().getCoordinatesList().get(1).getD(), 2.5, DELTA);
    assertEquals(astPolar.get().getCoordinatesList().get(1).getPhi(), 1.3, DELTA);
    
    assertEquals(astPolar.get().getCoordinatesList().get(2).getD(), 47.11, DELTA);
    assertEquals(astPolar.get().getCoordinatesList().get(2).getPhi(), 0.815, DELTA);
  }
  ...
  public void cartesian2Polar() throws IOException {
    ...
    assertEquals(astPolar.get().getCoordinatesList().get(0).getD(), 4.47213, DELTA);
    assertEquals(astPolar.get().getCoordinatesList().get(0).getPhi(), 1.10714, DELTA);
    
    assertEquals(astPolar.get().getCoordinatesList().get(1).getD(), 5.38516, DELTA);
    assertEquals(astPolar.get().getCoordinatesList().get(1).getPhi(), 0.380506, DELTA);
    
    assertEquals(astPolar.get().getCoordinatesList().get(2).getD(), 7.07106, DELTA);
    assertEquals(astPolar.get().getCoordinatesList().get(2).getPhi(), 1.428899, DELTA);
  ...
  public void mirrorTransformation() throws IOException {
    ...
    assertEquals(astTransformed.get().getCoordinatesList().size(), 3);
    
    assertEquals(astTransformed.get().getCoordinatesList().get(0).getX(), 4);
    assertEquals(astTransformed.get().getCoordinatesList().get(0).getY(), 2);
    
    assertEquals(astTransformed.get().getCoordinatesList().get(1).getX(), 2);
    assertEquals(astTransformed.get().getCoordinatesList().get(1).getY(), 5);
    
    assertEquals(astTransformed.get().getCoordinatesList().get(2).getX(), 7);
    assertEquals(astTransformed.get().getCoordinatesList().get(2).getY(), 1);
