...
public class JavaAttributeMIValue extends WriteableMIValue {
  ...
  Object obj; // null -> static attribute (that's how java does it)
  Field attribute;
  ...
  public void write(MIValue value) {
    try {
      ...
      String errorMsg = "0x57094 Failed to assign value " + value.printType()
          + "(" + value.printValue() + ") to  attribute '" + attribute.getName()
