...
* [MIValue](values/MIValue.java)
   ...
   * [DoubleMIValue](values/DoubleMIValue.java)
     (represents doubles)
   * [ObjectMIValue](values/MIValueObject.java)
     (represents native Java objects)
   * [FunctionMIValue](values/FunctionMIValue.java)
     (represents functions)
     * [ModelFunctionMIValue](values/ModelFunctionMIValue.java)
       (function declared within the model, e.g., lambdas)
     * [MethodHandleFunction](values/MethodHandleFunction.java)
       (native java method)
     * [VoidMIValue](values/VoidMIValue.java)
       (represents void, rarely used except for function returns)
   * [ErrorMIValue](values/ErrorMIValue.java)
     (An internal error occurred or an exception was thrown)
   * [MIFlowControlSignal](values/MIFlowControlSignal.java)
     (signal that unwinds the stack)
     * [MIBreakSignal](values/MIBreakSignal.java)
       (represents `break`)
     * [MIContinueSignal](values/MIContinueSignal.java)
       (represents `continue`)
     * [MIReturnSignal](values/MIReturnSignal.java)
...
* Traversers
   * Expressions
      * [AssignmentExpressionInterpreter](../expressions/assignmentexpressions/interpreter/AssignmentExpressionsInterpreter.java)
   ...
   * Statements
      ...
      * [MCVariableDeclarationStatementsInterpreter](../statements/mcvardeclarationstatements/interpreter/MCVarDeclarationStatementsInterpreter.java)
