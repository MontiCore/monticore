...
public class ASTDeleteOperation extends ASTDeleteOperationTOP {
  ...
  protected ASTDeleteOperation(String name, String type, String simpleType, String grammarType,
      String typepackage, List<String> parentsSets, boolean list) {
    super();
    setName(name);
    setType(type);
  ...
  protected ASTDeleteOperation(HashMap<String, List<String>> possibleParents, String name,
      String type, String simpleType, String grammarType, String typepackage,
      List<String> parentsSets, boolean list) {
    super();
    setName(name);
    setType(type);
    setSimpleType(simpleType);
