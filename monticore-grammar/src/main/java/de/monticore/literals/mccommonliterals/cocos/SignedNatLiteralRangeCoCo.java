...
public class SignedNatLiteralRangeCoCo implements MCCommonLiteralsASTSignedNatLiteralCoCo {
  ...
  public SignedNatLiteralRangeCoCo(){
    this.min = BigInteger.valueOf(Integer.MIN_VALUE);
    this.max = BigInteger.valueOf(Integer.MAX_VALUE);
  }

  public SignedNatLiteralRangeCoCo(BigInteger min, BigInteger max){
    this.min = min;
    this.max = max;
  }
