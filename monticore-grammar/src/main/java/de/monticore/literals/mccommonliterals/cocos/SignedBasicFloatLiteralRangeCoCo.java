...
public class SignedBasicFloatLiteralRangeCoCo implements MCCommonLiteralsASTSignedBasicFloatLiteralCoCo {
  ...
  public SignedBasicFloatLiteralRangeCoCo(BigDecimal min, BigDecimal max){
    this.min = min;
    this.max = max;
  }
