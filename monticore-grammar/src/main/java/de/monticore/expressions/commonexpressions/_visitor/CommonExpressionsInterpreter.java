...
public class CommonExpressionsInterpreter extends CommonExpressionsInterpreterTOP {
  ...
  public MIValue interpret(ASTPlusExpression node) {
    ...
    if (left.isFlowControlSignal())
      return left;
    if (right.isFlowControlSignal())
      return right;
  ...
  protected SymTypePrimitive getCompatibleType(SymTypePrimitive type1, SymTypePrimitive type2) {
   ...
   */
  protected MIValue isEqual(SymTypePrimitive leftType, MIValue left, SymTypePrimitive rightType, MIValue right) {
   ...
   */
  protected MIValue subtract(SymTypePrimitive leftType, MIValue left, SymTypePrimitive rightType, MIValue right) {
    SymTypePrimitive compatibleType = getCompatibleType(leftType, rightType);
    if (compatibleType == null) {
