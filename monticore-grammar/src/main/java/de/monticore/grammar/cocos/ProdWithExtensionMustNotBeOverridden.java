...
import static de.monticore.grammar.MCGrammarSymbolTableHelper.getAllSuperGrammars;
import static de.monticore.grammar.MCGrammarSymbolTableHelper.getMCGrammarSymbol;
...
public class ProdWithExtensionMustNotBeOverridden implements GrammarASTProdCoCo {
  ...
  public void check(ASTProd a) {
    ...
    for (Entry<String, ProdSymbol> entry : grammarSymbol.get().getProdsWithInherited()
      ...
      for (ProdSymbolSurrogate typeSymbol : rs.getSuperProds()) {
