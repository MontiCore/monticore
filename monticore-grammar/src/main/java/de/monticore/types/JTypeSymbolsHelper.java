...
import de.monticore.types.mcbasictypes._ast.ASTReturnType;
...
import de.monticore.types.mcgenerictypes._ast.ASTTypeParameters;
import de.monticore.types.mcgenerictypes._ast.ASTTypeVariableDeclaration;
...
public class JTypeSymbolsHelper {
  ...
  public static void addTypeArgumentsToTypeSymbol(
    ...
    if (astType.getTypeOpt().isPresent() && astType.getType() instanceof ASTQualifiedReferenceType) {
      ASTQualifiedReferenceType astSimpleReferenceType = (ASTQualifiedReferenceType) astType.getType();
//
...
//      }
    ...
    else if (astType.getTypeOpt().isPresent() && astType.getType() instanceof ASTComplexReferenceType) {
      ASTComplexReferenceType astComplexReferenceType = (ASTComplexReferenceType) astType.getType();
      for (ASTBasicGenericsReferenceType astSimpleReferenceType : astComplexReferenceType
          .getBasicGenericsReferenceTypeList()) {
        // TODO
