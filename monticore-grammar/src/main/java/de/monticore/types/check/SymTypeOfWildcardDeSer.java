...
public class SymTypeOfWildcardDeSer {
  ...
  public SymTypeOfWildcard deserialize(String serialized, ITypeSymbolsScope enclosingScope) {
    return deserialize(JsonParser.parse(serialized), enclosingScope);
  }

  public SymTypeOfWildcard deserialize(JsonElement serialized, ITypeSymbolsScope enclosingScope) {
