...
public class Subcomponent2VariableAdapterTest {
  ...
  void shouldAdaptFields() {
    ...
    assertAll(
        ...
        () -> assertEquals(adaptee.getType().getTypeInfo(), ((ComponentType2TypeSymbolAdapter) adapter.getType().getTypeInfo()).getAdaptee(),
        ...
        () -> assertEquals(BasicAccessModifier.PRIVATE, adapter.getAccessModifier(),
  ...
  void shouldDeepClone() {
    ...
    assertAll(
        ...
        () -> assertEquals(((ComponentType2TypeSymbolAdapter) adapter.getType().getTypeInfo()).getAdaptee(), ((ComponentType2TypeSymbolAdapter) clone.getType().getTypeInfo()).getAdaptee(),
  ...
  void shouldNotThrowErrorIfTypeIsMissing() {
    ...
    assertAll(
        ...
        () -> assertEquals(adaptee.getFullName(), adapter.getFullName(),
            "The adapter's full name should match the adaptee's full name."),
        () -> assertTrue(adapter.getType().isObscureType(),
