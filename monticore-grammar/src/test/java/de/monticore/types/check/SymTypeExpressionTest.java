...
public class SymTypeExpressionTest {
  ...
  public void printAsJsonTest() {
    ...
    assertEquals("de.monticore.types.check.SymTypeOfObject", teSetArgsJson.get(0).getAsJsonObject().getStringMember("kind"));
    ...
    assertEquals("de.monticore.types.check.SymTypeVariable", teSetAArgsJson.get(0).getAsJsonObject().getStringMember("kind"));
    ...
    assertEquals("de.monticore.types.check.SymTypePrimitive", teMapArgsJson.get(0).getAsJsonObject().getStringMember("kind"));
    assertEquals("int", teMapArgsJson.get(0).getAsJsonObject().getStringMember("primitiveName"));
    assertEquals("de.monticore.types.check.SymTypeOfObject", teMapArgsJson.get(1).getAsJsonObject().getStringMember("kind"));
    ...
    assertEquals("de.monticore.types.check.SymTypeOfObject", teFooArgsJson.get(0).getAsJsonObject().getStringMember("kind"));
    assertEquals("de.x.Person", teFooArgsJson.get(0).getAsJsonObject().getStringMember("objName"));
    assertEquals("de.monticore.types.check.SymTypePrimitive", teFooArgsJson.get(1).getAsJsonObject().getStringMember("kind"));
    assertEquals("double", teFooArgsJson.get(1).getAsJsonObject().getStringMember("primitiveName"));
    assertEquals("de.monticore.types.check.SymTypePrimitive", teFooArgsJson.get(2).getAsJsonObject().getStringMember("kind"));
    assertEquals("int", teFooArgsJson.get(2).getAsJsonObject().getStringMember("primitiveName"));
    assertEquals("de.monticore.types.check.SymTypeOfObject", teFooArgsJson.get(3).getAsJsonObject().getStringMember("kind"));
    ...
    assertEquals("de.monticore.types.check.SymTypeOfUnion", teUnion1Json.getStringMember("kind"));
    ...
    assertEquals("de.monticore.types.check.SymTypePrimitive", union1Types.get(0).getAsJsonObject().getStringMember( "kind"));
    assertEquals("double", union1Types.get(0).getAsJsonObject().getStringMember( "primitiveName"));
    assertEquals("de.monticore.types.check.SymTypePrimitive", union1Types.get(1).getAsJsonObject().getStringMember( "kind"));
    assertEquals("int", union1Types.get(1).getAsJsonObject().getStringMember( "primitiveName"));

    result = JsonParser.parse(teInter1.printAsJson());
    assertTrue(result.isJsonObject());
    JsonObject teInter1Json = result.getAsJsonObject();
    assertEquals("de.monticore.types.check.SymTypeOfIntersection", teInter1Json.getStringMember("kind"));
    ...
    assertEquals("de.monticore.types.check.SymTypePrimitive", intersected1Types.get(0).getAsJsonObject().getStringMember( "kind"));
    assertEquals("double", intersected1Types.get(0).getAsJsonObject().getStringMember( "primitiveName"));
    assertEquals("de.monticore.types.check.SymTypePrimitive", intersected1Types.get(1).getAsJsonObject().getStringMember( "kind"));
    assertEquals("int", intersected1Types.get(1).getAsJsonObject().getStringMember( "primitiveName"));

    result = JsonParser.parse(teTuple1.printAsJson());
    assertTrue(result.isJsonObject());
    JsonObject teTuple1Json = result.getAsJsonObject();
    assertEquals("de.monticore.types.check.SymTypeOfTuple", teTuple1Json.getStringMember("kind"));
    ...
    assertEquals("de.monticore.types.check.SymTypePrimitive", tuple1types.get(0).getAsJsonObject().getStringMember( "kind"));
    assertEquals("int", tuple1types.get(0).getAsJsonObject().getStringMember( "primitiveName"));
    assertEquals("de.monticore.types.check.SymTypePrimitive", tuple1types.get(1).getAsJsonObject().getStringMember( "kind"));
    assertEquals("double", tuple1types.get(1).getAsJsonObject().getStringMember( "primitiveName"));

    result = JsonParser.parse(teRegEx1.printAsJson());
    assertTrue(result.isJsonObject());
    JsonObject teRegEx1Json = result.getAsJsonObject();
    assertEquals("de.monticore.types.check.SymTypeOfRegEx", teRegEx1Json.getStringMember("kind"));
    assertEquals("gr(a|e)y", teRegEx1Json.getStringMember("regex"));
  }
  ...
  public void deepCloneTest(){
    ...
    assertTrue(teVarUpper.deepClone() instanceof SymTypeInferenceVariable);
    assertFalse(teVarUpper.deepClone().isPrimitive());
    assertTrue(teVarUpper.deepClone().isInferenceVariable());
    assertEquals(teVarUpper.print(), teVarUpper.deepClone().print());

    assertTrue(teVarLower.deepClone() instanceof SymTypeInferenceVariable);
    assertFalse(teVarLower.deepClone().isPrimitive());
    assertTrue(teVarLower.deepClone().isInferenceVariable());
  ...
  public void testSymTypeExpressionFactory(){
    ...
    assertInstanceOf(SymTypeVoid.class, tExpr);
