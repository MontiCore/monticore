...
public class MCTypeFacadeTest {
  ...
  public void testCreateBasicTypeArgumentOf() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getMCTypeOpt().get());
  ...
  public void testCreateWildCardWithUpperBoundTypeClass() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getUpperBound());
  ...
  public void testCreateOptionalTypeOfClass() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getMCTypeArgument().getMCTypeOpt().get());
  ...
  public void testCreateCollectionTypeOfClass() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getMCTypeArgument(0).getMCTypeOpt().get());
    assertEquals(Lists.newArrayList("String"), ((ASTMCQualifiedType) type.getMCTypeArgument(0).getMCTypeOpt().get()).getNameList());
  ...
  public void testCreateMapTypeOfClass() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getKey().getMCTypeOpt().get());
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getValue().getMCTypeOpt().get());
  ...
  public void testCreateBasicGenericTypeOfNameList() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getMCTypeArgument(1).getMCTypeOpt().get());
  ...
  public void testCreateArrayTypeString() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type.getMCType());
  ...
  public void testCreatePrimitiveType() {
    ...
    assertInstanceOf(ASTMCQualifiedType.class, type);
