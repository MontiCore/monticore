...
public class WhileConditionHasBooleanTypeTest extends CocoTest {
  ...
  public static void disableFailQuick(){
    ...
    checker.addCoCo(new WhileConditionHasBooleanType(new TypeCheck(null,new DeriveSymTypeOfCombineExpressionsDelegator())));
