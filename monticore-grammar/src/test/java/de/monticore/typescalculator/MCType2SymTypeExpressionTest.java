...
public class MCType2SymTypeExpressionTest {
  ...
  public void testBasicGeneric() throws IOException {
    ...
    SymTypeExpression listSymTypeExpression = TypesCalculatorHelper.mcType2TypeExpression(type.get());
    assertTrue(listSymTypeExpression instanceof SymGenericTypeExpression);
    assertTrue("de.util.Pair".equals(listSymTypeExpression.getName()));
    SymTypeExpression keyTypeArgument = ((SymGenericTypeExpression) listSymTypeExpression).getArguments().get(0);
    assertTrue(keyTypeArgument instanceof SymObjectType);
    assertTrue("de.mc.PairA".equals(keyTypeArgument.getName()));

    SymTypeExpression valueTypeArgument = ((SymGenericTypeExpression) listSymTypeExpression).getArguments().get(1);
    assertTrue(valueTypeArgument instanceof SymObjectType);
  ...
  public void testBasicGenericRekursiv() throws IOException {
    ...
    SymTypeExpression valueTypeArgument = ((SymGenericTypeExpression) listSymTypeExpression).getArguments().get(1);
    assertTrue(valueTypeArgument instanceof SymGenericTypeExpression);
    assertEquals("de.util.Pair2",valueTypeArgument.getName());

    SymGenericTypeExpression valueTypeArg = (SymGenericTypeExpression) valueTypeArgument;
  ...
  public void testOptional() throws IOException {
    ...
    SymTypeExpression listTypeArgument = ((SymGenericTypeExpression) listSymTypeExpression).getArguments().get(0);
    assertTrue(listTypeArgument instanceof SymObjectType);
  ...
  public void testOptionalUnqualified() throws IOException {
    ...
    assertTrue(type.isPresent());
    SymTypeExpression setSymTypeExpression = TypesCalculatorHelper.mcType2TypeExpression(type.get());
    assertTrue(setSymTypeExpression instanceof SymGenericTypeExpression);
    assertTrue("Optional".equals(setSymTypeExpression.getName()));
    SymTypeExpression listTypeArgument = ((SymGenericTypeExpression) setSymTypeExpression).getArguments().get(0);
    assertTrue(listTypeArgument instanceof SymObjectType);
...
//TODO RE Fix Types Grammar/AST
  ...
  public void testPrimitives() throws IOException {
    ...
    for(String primitive : primitiveTypes) {
      ...
      SymTypeExpression symTypeExpression = TypesCalculatorHelper.mcType2TypeExpression(booleanType);
  ...
  public void testQualifiedType() throws IOException {
    ...
    SymTypeExpression symTypeExpression = TypesCalculatorHelper.mcType2TypeExpression(qualifiedType);
    assertTrue(symTypeExpression instanceof SymObjectType);
  ...
  public void testQualifiedName() throws IOException {
    ...
    SymTypeExpression symTypeExpression = TypesCalculatorHelper.mcType2TypeExpression(qualifiedName);
    assertTrue(symTypeExpression instanceof SymObjectType);
    assertTrue("de.mc.Person".equals(symTypeExpression.getName()));
  }
  @Test
