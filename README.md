...
(MontiCore LWB, tool derivates, product code). Each has its own  
licenses: 

* *Product code generated by a MontiCore tool derivate 
is absolutely free* for each form of use 
including commercial use without any license restriction. 

* *Tool derivate* created using the MontiCore language 
...
when you mention MontiCore and publish the resulting code 
back into this repository (LGPL license). 
