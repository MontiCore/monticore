...
/**
 * A border extension of {@link MarginBorder} that draws a border at the top of
 * a {@link IFigure}.
 * 
 * @author Tim Enger
 */
public class TopSeparatorBorder extends MarginBorder {
   ...
   */
  public TopSeparatorBorder(int width, Color color) {
   ...
   * @param color Line color
   */
  public TopSeparatorBorder(int t, int l, int b, int r, int width, Color color) {
    super(t, l, b, r);
    this.width = width;
    this.color = color;
  }
