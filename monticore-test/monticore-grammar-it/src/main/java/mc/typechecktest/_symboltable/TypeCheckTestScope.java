...
public class TypeCheckTestScope extends TypeCheckTestScopeTOP {

  public TypeCheckTestScope() {
    super();
  }

  public TypeCheckTestScope(boolean isShadowingScope) {
    super(isShadowingScope);
  }

  public TypeCheckTestScope(ITypeCheckTestScope enclosingScope) {
    this(enclosingScope, false);
  }

  public TypeCheckTestScope(ITypeCheckTestScope enclosingScope, boolean isShadowingScope) {
