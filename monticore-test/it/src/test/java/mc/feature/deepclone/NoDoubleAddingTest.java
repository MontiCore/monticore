...
import mc.feature.deepclone.nodoubleadding.NoDoubleAddingMill;
...
@TestWithMCLanguage(NoDoubleAddingMill.class)
public class NoDoubleAddingTest {
  ...
  public void testNoDoubleListElements() throws IOException {
    ...
    NoDoubleAddingParser parser = NoDoubleAddingMill.parser();
