...
@TestWithMCLanguage(SupGrammarRefMill.class)
public class SupReferenceTest {
  ...
  public void testWithoutSymbolTableList() throws IOException {
    ...
    assertEquals(3, supRefList.sizeNames());
  ...
  public void testSupRefOptSet() {
    ...
    assertTrue(supRefOpt.isPresentNameSymbol());
    assertTrue(supRefOpt.isPresentName());
    assertEquals("C", supRefOpt.getName());
  ...
  public void testSupRefList() {
    ...
    assertEquals(4, supRefList.sizeNames());
    assertEquals(4, supRefList.sizeNamesDefinition());
    assertEquals(4, supRefList.sizeNamesSymbol());
    ...
    assertEquals(4, supRefList.toArrayNames().length);
    assertEquals(4, supRefList.toArrayNamesSymbol().length);
    assertEquals(4, supRefList.toArrayNamesDefinition().length);
  }
  ...
  public void testSupRefListSet() {
    ...
    assertEquals(2, supRefList.sizeNames());
    assertEquals(2, supRefList.sizeNamesDefinition());
    assertEquals(2, supRefList.sizeNamesSymbol());
