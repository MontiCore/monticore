...
public class EmfDiffTest {
  ...
  @Disabled
  @Test
  public void testDiffAutomaton() throws IOException, InterruptedException {
    ...
    Optional<ASTAutomaton> transC =
        new FlatAutomatonParser().parse("src/test/resources/mc/emf/diff/Testautomat2.aut");
    ...
    assertEquals("The order of the values of reference Transitions have been changed",
    ...
    assertEquals("ASTTransition From: a Activate: x To: c has been removed",
        diffs.get(10).toString());
  }
}