...
public abstract class ASTBasicEObjectImplNode extends ASTBasicNotifierImplNode implements EObject,
    InternalEObject {
  /**
   ...
   */
  protected ASTBasicEObjectImplNode() {
    super();
  }
  ...
  public String eURIFragmentSegment(EStructuralFeature eStructuralFeature, EObject eObject) {
    if (eStructuralFeature == null) {
      ...
      EContentsEList.FeatureIterator<EObject> crossReferences =
          (EContentsEList.FeatureIterator<EObject>) ((InternalEList<?>) eCrossReferences())
  ...
  private static void eEncodeValue(StringBuilder result, EFactory eFactory, EDataType eDataType,
      Object value) {
      ...
      if (Character.isDigit(lastChar)) {
        ...
        if (dotIndex >= 0) {
          EList<?> eList = (EList<?>) eGet(
              eStructuralFeature(uriFragmentSegment.substring(1, dotIndex)), false);
          int position = 0;
          try {
  ...
  private static final void addEntry(List<FeatureMap.Entry> featureMapEntries,
      final EAttribute eAttribute, final Object value) {
  ...
  private EObject eObjectForURIFragmentPredicate(List<FeatureMap.Entry> predicate,
      ...
      if (result.eIsProxy()) {
        ...
        if (resolved != result) {
          ...
          if (eNotificationRequired() && eContainerFeatureID > EOPPOSITE_FEATURE_BASE) {
            eNotify(new ENotificationImpl(this, Notification.RESOLVE, eContainerFeatureID, result,
                resolved));
          }
          return resolved;
        }
  ...
  public EList<EObject> eCrossReferences() {
    ...
    if (result == null) {
      eBasicProperties().setECrossReferences(
  ...
  protected static EReference eContainmentFeature(EObject eObject, EObject eContainer,
    ...
    if (eContainer == null) {
      ...
      if (eContainerFeatureID <= EOPPOSITE_FEATURE_BASE) {
        ...
        return ((EReference) eObject.eClass().getEStructuralFeature(eContainerFeatureID))
            .getEOpposite();
      }
    }
  }
  ...
  public EStructuralFeature eContainingFeature() {
    ...
    if (eContainer == null) {
      ...
      int eContainerFeatureID = eContainerFeatureID();
      return eContainerFeatureID <= EOPPOSITE_FEATURE_BASE ?
  ...
  public NotificationChain eSetResource(Resource.Internal resource, NotificationChain notifications) {
    ...
    if (oldResource != null) {
      ...
      // When setting the resource to null we assume that detach has already
      // been called in the resource implementation
      //
      if (resource != null) {
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    ...
    return dynamicFeatureID < 0 ?
        eGet(eFeature, resolve) /* backward compatibility with old generated
                                 * overrides */:
  ...
  public Object eDynamicGet(int featureID, boolean resolve, boolean coreType) {
    return eDynamicGet(featureID - eStaticFeatureCount(),
        eClass().getEStructuralFeature(featureID), resolve, coreType);
  }
  
  protected Object eDynamicGet(int dynamicFeatureID, EStructuralFeature eFeature, boolean resolve,
      boolean coreType) {
    return dynamicFeatureID < 0 ?
  ...
  public Object eOpenGet(EStructuralFeature eFeature, boolean resolve) {
    ...
    if (openFeature != null) {
      ...
      throw new IllegalArgumentException("The feature '" + eFeature.getName()
  ...
  public void eSet(int featureID, Object newValue) {
    ...
    if (dynamicFeatureID < 0) {
      if (eFeature == null) {
        throw new IllegalArgumentException("The feature ID" + featureID
            + " is not a valid feature ID");
      }
      else if (!eFeature.isChangeable()) {
        throw new IllegalArgumentException("The feature '" + eFeature.getName()
            + "' is not a valid changeable feature");
      }
      else {
        eSet(eFeature, newValue); /* backward compatibility with old generated
                                   * overrides */
      }
    }
    else {
  ...
  public void eDynamicSet(int featureID, Object newValue) {
    eDynamicSet(featureID - eStaticFeatureCount(), eClass().getEStructuralFeature(featureID),
        newValue);
  }
  ...
  public boolean eDynamicIsSet(int featureID) {
    return eDynamicIsSet(featureID - eStaticFeatureCount(),
  ...
  public NotificationChain eDynamicBasicRemoveFromContainer(NotificationChain msgs) {
    EReference inverseFeature = ((EReference) eClass().getEStructuralFeature(eContainerFeatureID()))
        .getEOpposite();
    return eInternalContainer().eInverseRemove(this, inverseFeature.getFeatureID(),
        inverseFeature.getContainerClass(), msgs);
  }
  ...
  public NotificationChain eDynamicInverseAdd(InternalEObject otherEnd, int featureID,
      Class<?> inverseClass, NotificationChain msgs) {
    return eDynamicInverseAdd(otherEnd, featureID, msgs);
  }
  
  protected NotificationChain eDynamicInverseAdd(InternalEObject otherEnd, int featureID,
      NotificationChain msgs) {
    EStructuralFeature.Internal feature = (EStructuralFeature.Internal) eClass()
        .getEStructuralFeature(featureID);
    return feature.getSettingDelegate().dynamicInverseAdd(this, eSettings(),
        featureID - eStaticFeatureCount(), otherEnd, msgs);
  }
  ...
  public NotificationChain eDynamicInverseRemove(InternalEObject otherEnd, int featureID,
      Class<?> inverseClass, NotificationChain msgs) {
    return eDynamicInverseRemove(otherEnd, featureID, msgs);
  }
  
  protected NotificationChain eDynamicInverseRemove(InternalEObject otherEnd, int featureID,
      NotificationChain msgs) {
    EStructuralFeature.Internal feature = (EStructuralFeature.Internal) eClass()
        .getEStructuralFeature(featureID);
    return feature.getSettingDelegate().dynamicInverseRemove(this, eSettings(),
        featureID - eStaticFeatureCount(), otherEnd, msgs);
  }
  ...
  public int eDerivedStructuralFeatureID(EStructuralFeature eStructuralFeature) {
    ...
    if (containerClass == null) {
      ...
      assert eClass().getEAllStructuralFeatures().contains(eStructuralFeature) : "The feature '"
          + eStructuralFeature.getName() + "' is not a valid feature";
  ...
  public EStructuralFeature.Setting eSetting(final EStructuralFeature eFeature) {
    ...
    if (index >= dynamicIndex) {
      ...
      if (openFeature != null) {
        ...
        if (upperBound > 1 || upperBound == ETypedElement.UNBOUNDED_MULTIPLICITY) {
          return (EStructuralFeature.Setting) ((FeatureMap.Internal) featureMap).get(eFeature,
              false);
        }
      }
      else {
    ...
    EStructuralFeature.Setting setting =
        new EStructuralFeature.Setting()
        {
          ...
          {
            return ASTBasicEObjectImplNode.this;
          }
          ...
          {
            return ASTBasicEObjectImplNode.this.eGet(eFeature, resolve);
          }
          
          public void set(Object newValue)
          {
            ASTBasicEObjectImplNode.this.eSet(eFeature, newValue);
          }
          
          public boolean isSet()
          {
            return ASTBasicEObjectImplNode.this.eIsSet(eFeature);
          }
          
          public void unset()
          {
            ASTBasicEObjectImplNode.this.eUnset(eFeature);
          }
        };
    return setting;
  }
  ...
  /**
   * Returns the {@link #eBasicAdapterArray() adapter array} of the
   * {@link #eInternalContainer() container}.
   * 
   * @return the adapter array of the container.
   */
  protected Adapter[] eContainerAdapterArray() {
    InternalEObject eInternalContainer = eInternalContainer();
    return eInternalContainer instanceof ASTBasicEObjectImplNode ?
        ((ASTBasicEObjectImplNode) eInternalContainer).eBasicAdapterArray() :
        null;
  }
   ...
   * currently have and index allocated in the {@link #eVirtualValues() virtual
   * values}.
   * 
  ...
  protected int eVirtualIndex(int eDerivedStructuralFeatureID, int action) {
    ...
    switch (action) {
      case EVIRTUAL_IS_SET: {
        // For isSet, we only need to check the bit and return -1 when the bit
        // is 0.
        //
        return bit - 1;
      }
   ...
   * 
   * @param index the {@link #eVirtualIndex(int, int) index} in the
   * {@link #eVirtualValues() virtual values}.
  ...
  /**
   * This method controls the growth of the {@link #eVirtualValues() virtual
   * values} by returning the new capacity that should be allocated for the
   * given minimum required capacity. Subclasses can override this to be more or
   * less liberal in growth.
   * 
   * @param minimumCapacity the minimum number of virtual value entries
   * required.
  ...
  /**
   * Returns the value for the feature ID, or <code>null</code>, if there isn't
   * one.
   * 
